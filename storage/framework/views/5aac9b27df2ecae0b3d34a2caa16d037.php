...
<a href="<?php echo e($url); ?>" class="group block focus:outline-none focus-visible:ring ring-indigo-400 rounded-2xl">
  <article class="bg-zinc-900/70 border border-zinc-800 rounded-2xl overflow-hidden transition
    ...
    <div class="p-4 space-y-2">
      ...
      <p class="text-[11px] text-zinc-400">
        <?php echo e(\Carbon\Carbon::parse($post->published_at ?? $post->created_at ?? now())->locale('es')->diffForHumans()); ?>

      </p>
    </div>
  </article>
</a><?php /**PATH C:\Users\USER\panorama\resources\views/partials/news-card.blade.php ENDPATH**/ ?>