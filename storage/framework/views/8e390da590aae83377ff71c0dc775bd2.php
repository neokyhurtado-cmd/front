...
<html lang="es" class="scroll-smooth">
  <head>
    ...
    <title><?php echo $__env->yieldContent('title','PANORAMA INGENIERIA IA'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Noticias de movilidad y señalización vial con IA'); ?>">
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/future-ui.css', 'resources/js/app.js']); ?>
  ...
  <body class="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
    ...
    <header class="sticky top-0 z-40 border-b border-[var(--card-border)] bg-[var(--bg)]/90 backdrop-blur">
      <div class="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        <a href="<?php echo e(url('/')); ?>" class="font-bold tracking-wide text-xl">PANORAMA INGENIERIA IA</a>
